defmodule HouseWeb.CoreComponents do
  @moduledoc """
  ...
  def simple_form(assigns) do
    ...
    <.form :let={f} for={@for} as={@as} {@rest}>
      <div class="mt-10 space-y-8 dark:bg-zinc-900">
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(HouseWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(HouseWeb.Gettext, "errors", msg, opts)
    end
  end
